...
This Github Action 'pipeline' is a way to get your automation back. Rather than wrapping it as a "proper" Github Action, I feel it is better to provide the script "as is" - since it's a single step - to allow for changes relevant to your specific package.
